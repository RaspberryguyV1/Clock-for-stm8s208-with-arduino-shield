  ...
  50                     ; 54 void ADC2_DeInit(void)
  50                     ; 55 {
  52                     .text:	section	.text,new
  53  0000               _ADC2_DeInit:
  57                     ; 56   ADC2->CSR  = ADC2_CSR_RESET_VALUE;
  59  0000 725f5400      	clr	21504
  60                     ; 57   ADC2->CR1  = ADC2_CR1_RESET_VALUE;
  62  0004 725f5401      	clr	21505
  63                     ; 58   ADC2->CR2  = ADC2_CR2_RESET_VALUE;
  65  0008 725f5402      	clr	21506
  66                     ; 59   ADC2->TDRH = ADC2_TDRH_RESET_VALUE;
  68  000c 725f5406      	clr	21510
  69                     ; 60   ADC2->TDRL = ADC2_TDRL_RESET_VALUE;
  71  0010 725f5407      	clr	21511
  72                     ; 61 }
  75  0014 81            	ret	
 602                     ; 83 void ADC2_Init(ADC2_ConvMode_TypeDef ADC2_ConversionMode, ADC2_Channel_TypeDef ADC2_Channel, ADC2_PresSel_TypeDef ADC2_PrescalerSelection, ADC2_ExtTrig_TypeDef ADC2_ExtTrigger, FunctionalState ADC2_ExtTriggerState, ADC2_Align_TypeDef ADC2_Align, ADC2_SchmittTrigg_TypeDef ADC2_SchmittTriggerChannel, FunctionalState ADC2_SchmittTriggerState)
 602                     ; 84 {
 603                     .text:	section	.text,new
 604  0000               _ADC2_Init:
 606  0000 89            	pushw	x
 607       00000000      OFST:	set	0
 610                     ; 86   assert_param(IS_ADC2_CONVERSIONMODE_OK(ADC2_ConversionMode));
 612  0001 9e            	ld	a,xh
 613  0002 4d            	tnz	a
 ...
 618  0009 ae0056        	ldw	x,#86
 619  000c cd0122        	call	LC001
 620  000f               L41:
 621                     ; 87   assert_param(IS_ADC2_CHANNEL_OK(ADC2_Channel));
 ...
 655  004f ae0057        	ldw	x,#87
 656  0052 cd0122        	call	LC001
 657  0055               L42:
 658                     ; 88   assert_param(IS_ADC2_PRESSEL_OK(ADC2_PrescalerSelection));
 ...
 742  00e7 ae005c        	ldw	x,#92
 743  00ea ad36          	call	LC001
 744  00ec               L47:
 745                     ; 93   assert_param(IS_FUNCTIONALSTATE_OK(ADC2_SchmittTriggerState));
 747  00ec 7b0a          	ld	a,(OFST+10,sp)
 748  00ee 2708          	jreq	L401
 749  00f0 4a            	dec	a
 750  00f1 2705          	jreq	L401
 751  00f3 ae005d        	ldw	x,#93
 752  00f6 ad2a          	call	LC001
 753  00f8               L401:
 754                     ; 98   ADC2_ConversionConfig(ADC2_ConversionMode, ADC2_Channel, ADC2_Align);
 ...
 802  012d 81            	ret	
 838                     ; 121 void ADC2_Cmd(FunctionalState NewState)
 838                     ; 122 {
 839                     .text:	section	.text,new
 840  0000               _ADC2_Cmd:
 842  0000 88            	push	a
 843       00000000      OFST:	set	0
 846                     ; 124   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 848  0001 4d            	tnz	a
 849  0002 2711          	jreq	L621
 850  0004 4a            	dec	a
 851  0005 270e          	jreq	L621
 852  0007 ae007c        	ldw	x,#124
 853  000a 89            	pushw	x
 854  000b 5f            	clrw	x
 855  000c 89            	pushw	x
 ...
 860  0015               L621:
 861                     ; 126   if (NewState != DISABLE)
 863  0015 7b01          	ld	a,(OFST+1,sp)
 864  0017 2706          	jreq	L113
 865                     ; 128     ADC2->CR1 |= ADC2_CR1_ADON;
 867  0019 72105401      	bset	21505,#0
 869  001d 2004          	jra	L313
 870  001f               L113:
 871                     ; 132     ADC2->CR1 &= (uint8_t)(~ADC2_CR1_ADON);
 873  001f 72115401      	bres	21505,#0
 874  0023               L313:
 875                     ; 134 }
 878  0023 84            	pop	a
 879  0024 81            	ret	
 915                     ; 141 void ADC2_ITConfig(FunctionalState NewState)
 915                     ; 142 {
 ...
 955  0023 84            	pop	a
 956  0024 81            	ret	
 993                     ; 164 void ADC2_PrescalerConfig(ADC2_PresSel_TypeDef ADC2_Prescaler)
 993                     ; 165 {
 994                     .text:	section	.text,new
 995  0000               _ADC2_PrescalerConfig:
 997  0000 88            	push	a
 998       00000000      OFST:	set	0
1001                     ; 167   assert_param(IS_ADC2_PRESSEL_OK(ADC2_Prescaler));
1003  0001 4d            	tnz	a
...
1027  002e               L251:
1028                     ; 170   ADC2->CR1 &= (uint8_t)(~ADC2_CR1_SPSEL);
1030  002e c65401        	ld	a,21505
1031  0031 a48f          	and	a,#143
1032  0033 c75401        	ld	21505,a
1033                     ; 172   ADC2->CR1 |= (uint8_t)(ADC2_Prescaler);
...
1041  003e 84            	pop	a
1042  003f 81            	ret	
1090                     ; 183 void ADC2_SchmittTriggerConfig(ADC2_SchmittTrigg_TypeDef ADC2_SchmittTriggerChannel, FunctionalState NewState)
1090                     ; 184 {
1091                     .text:	section	.text,new
1092  0000               _ADC2_SchmittTriggerConfig:
1094  0000 89            	pushw	x
1095       00000000      OFST:	set	0
1098                     ; 186   assert_param(IS_ADC2_SCHMITTTRIG_OK(ADC2_SchmittTriggerChannel));
...
1215  00a2               L114:
1216                     ; 210       ADC2->TDRL |= (uint8_t)((uint8_t)0x01 << (uint8_t)ADC2_SchmittTriggerChannel);
...
1227  00af               L704:
1228                     ; 215     if (NewState != DISABLE)
1230  00af 2710          	jreq	L714
1231                     ; 217       ADC2->TDRH &= (uint8_t)(~(uint8_t)((uint8_t)0x01 << ((uint8_t)ADC2_SchmittTriggerChannel - (uint8_t)8)));
...
1245  00c1               L714:
1246                     ; 221       ADC2->TDRH |= (uint8_t)((uint8_t)0x01 << ((uint8_t)ADC2_SchmittTriggerChannel - (uint8_t)8));
...
1279  00e4 81            	ret	
1337                     ; 236 void ADC2_ConversionConfig(ADC2_ConvMode_TypeDef ADC2_ConversionMode, ADC2_Channel_TypeDef ADC2_Channel, ADC2_Align_TypeDef ADC2_Align)
1337                     ; 237 {
1338                     .text:	section	.text,new
1339  0000               _ADC2_ConversionConfig:
1341  0000 89            	pushw	x
1342       00000000      OFST:	set	0
1345                     ; 239   assert_param(IS_ADC2_CONVERSIONMODE_OK(ADC2_ConversionMode));
...
1353  0009 ae00ef        	ldw	x,#239
1354  000c cd008e        	call	LC006
1355  000f               L622:
1356                     ; 240   assert_param(IS_ADC2_CHANNEL_OK(ADC2_Channel));
...
1448  0099 81            	ret	
1495                     ; 275 void ADC2_ExternalTriggerConfig(ADC2_ExtTrig_TypeDef ADC2_ExtTrigger, FunctionalState NewState)
1495                     ; 276 {
1496                     .text:	section	.text,new
1497  0000               _ADC2_ExternalTriggerConfig:
1499  0000 89            	pushw	x
1500       00000000      OFST:	set	0
1503                     ; 278   assert_param(IS_ADC2_EXTTRIG_OK(ADC2_ExtTrigger));
...
1560  0045 81            	ret	
1584                     ; 308 void ADC2_StartConversion(void)
1584                     ; 309 {
1585                     .text:	section	.text,new
1586  0000               _ADC2_StartConversion:
1590                     ; 310   ADC2->CR1 |= ADC2_CR1_ADON;
1592  0000 72105401      	bset	21505,#0
1593                     ; 311 }
1596  0004 81            	ret	
1636                     ; 320 uint16_t ADC2_GetConversionValue(void)
1636                     ; 321 {
1637                     .text:	section	.text,new
1638  0000               _ADC2_GetConversionValue:
1640  0000 5205          	subw	sp,#5
1641       00000005      OFST:	set	5
1644                     ; 322   uint16_t temph = 0;
1646                     ; 323   uint8_t templ = 0;
1648                     ; 325   if ((ADC2->CR2 & ADC2_CR2_ALIGN) != 0) /* Right alignment */
1650  0002 720754020e    	btjf	21506,#3,L135
1651                     ; 328     templ = ADC2->DRL;
1653  0007 c65405        	ld	a,21509
1654  000a 6b03          	ld	(OFST-2,sp),a
1656                     ; 330     temph = ADC2->DRH;
1658  000c c65404        	ld	a,21508
1659  000f 97            	ld	xl,a
1661                     ; 332     temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
1663  0010 7b03          	ld	a,(OFST-2,sp)
1664  0012 02            	rlwa	x,a
1667  0013 201a          	jra	L335
1668  0015               L135:
1669                     ; 337     temph = ADC2->DRH;
1671  0015 c65404        	ld	a,21508
1672  0018 97            	ld	xl,a
1674                     ; 339     templ = ADC2->DRL;
1676  0019 c65405        	ld	a,21509
1677  001c 6b03          	ld	(OFST-2,sp),a
1679                     ; 341     temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)((uint16_t)temph << 8));
1681  001e 4f            	clr	a
1682  001f 02            	rlwa	x,a
1683  0020 1f01          	ldw	(OFST-4,sp),x
1685  0022 7b03          	ld	a,(OFST-2,sp)
1686  0024 97            	ld	xl,a
1687  0025 a640          	ld	a,#64
1688  0027 42            	mul	x,a
1689  0028 01            	rrwa	x,a
1690  0029 1a02          	or	a,(OFST-3,sp)
1691  002b 01            	rrwa	x,a
1692  002c 1a01          	or	a,(OFST-4,sp)
1693  002e 01            	rrwa	x,a
1695  002f               L335:
1696                     ; 344   return ((uint16_t)temph);
1700  002f 5b05          	addw	sp,#5
1701  0031 81            	ret	
1745                     ; 352 FlagStatus ADC2_GetFlagStatus(void)
1745                     ; 353 {
1746                     .text:	section	.text,new
1747  0000               _ADC2_GetFlagStatus:
1751                     ; 355   return (FlagStatus)(ADC2->CSR & ADC2_CSR_EOC);
1753  0000 c65400        	ld	a,21504
1754  0003 a480          	and	a,#128
1757  0005 81            	ret	
1780                     ; 363 void ADC2_ClearFlag(void)
1780                     ; 364 {
1781                     .text:	section	.text,new
1782  0000               _ADC2_ClearFlag:
1786                     ; 365   ADC2->CSR &= (uint8_t)(~ADC2_CSR_EOC);
1788  0000 721f5400      	bres	21504,#7
1789                     ; 366 }
1792  0004 81            	ret	
1816                     ; 374 ITStatus ADC2_GetITStatus(void)
1816                     ; 375 {
1817                     .text:	section	.text,new
1818  0000               _ADC2_GetITStatus:
1822                     ; 376   return (ITStatus)(ADC2->CSR & ADC2_CSR_EOC);
1824  0000 c65400        	ld	a,21504
1825  0003 a480          	and	a,#128
1828  0005 81            	ret	
1852                     ; 384 void ADC2_ClearITPendingBit(void)
1852                     ; 385 {
1853                     .text:	section	.text,new
1854  0000               _ADC2_ClearITPendingBit:
1858                     ; 386   ADC2->CSR &= (uint8_t)(~ADC2_CSR_EOC);
1860  0000 721f5400      	bres	21504,#7
1861                     ; 387 }
1864  0004 81            	ret	
1877                     	xdef	_ADC2_ClearITPendingBit
1878                     	xdef	_ADC2_GetITStatus
1879                     	xdef	_ADC2_ClearFlag
1880                     	xdef	_ADC2_GetFlagStatus
1881                     	xdef	_ADC2_GetConversionValue
1882                     	xdef	_ADC2_StartConversion
1883                     	xdef	_ADC2_ExternalTriggerConfig
1884                     	xdef	_ADC2_ConversionConfig
1885                     	xdef	_ADC2_SchmittTriggerConfig
1886                     	xdef	_ADC2_PrescalerConfig
1887                     	xdef	_ADC2_ITConfig
1888                     	xdef	_ADC2_Cmd
1889                     	xdef	_ADC2_Init
1890                     	xdef	_ADC2_DeInit
1891                     	xref	_assert_failed
1892                     .const:	section	.text
1893  0000               L172:
1894  0000 2e2e5c2e2e5c  	dc.b	"..\..\..\..\librar"
1895  0012 6965735c7374  	dc.b	"ies\stm8s_stdperip"
1896  0024 685f64726976  	dc.b	"h_driver\src\stm8s"
1897  0036 5f616463322e  	dc.b	"_adc2.c",0
1917                     	end
